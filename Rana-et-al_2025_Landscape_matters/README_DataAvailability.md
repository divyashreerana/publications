...
4. Network_generation a. Graphab project creation b. Node identification: Habitats with minimum area of species homerange from binary habitat suitability layer c. Resistance layer generation: Negative exponential transformation of the habitat suitability values ranging from 1 to 100 d. Complete spatial graph generation e. Pruned connectivity networks based on dispersal distance
5. Metric_calculation a. Computing network metrics from igraph R package b. Computing landscape traits from landscapemetrics R package for habitat buffers within each grid
6. Pattern_analysis a. Linear models of network properties with species and landscape traits b. Assessing relative importance of variables for groups of network properties c. Threshold senstivity analysis (+-25% dispersal distance)
